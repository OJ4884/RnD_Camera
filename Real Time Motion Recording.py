...
def start_recording():
    ...
    try:
        ...
        print("Motion detected - recording disabled during MJPEG streaming")
...
def frame_capture_thread():
    ...
    global prev_frame, motion_recording, motion_timer, motion_detected
    ...
    while streaming:
        ...
        try:
            ...
            cv2.rectangle(frame, (x_offset, y_offset), (x_offset + roi_width, y_offset + roi_height), (255, 0, 0), 2)
            roi = frame[y_offset:y_offset + roi_height, x_offset:x_offset + roi_width]
            ...
            if motion_recording:
                if time.time() - motion_timer > MOTION_RECORD_SECONDS:
                    print("Stopping motion recording (disabled)")
            ...
            if motion_detected and not motion_recording:
                ...
                try:
                    ...
                    enocder = H264Encoder(bitrate=1000000)
                    file_output = FileOutput(filename)
                    
                    camera.start_recording(enocder, file_output)
